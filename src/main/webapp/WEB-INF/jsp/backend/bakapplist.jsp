...
<div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            <div class="x_title">
                <h2>APP审核列表
                    <small><i class="fa fa-user"></i>${bakSession.userName}您可以通过搜索或者其他的选项对APP的信息修改、删除等管理操作。</small>
                </h2>
                </li>
        ...
        <div class="x_panel">
            ...
            <div align="center">
                <a href="${pageContext.request.contextPath}/bac/appinfo/list?pageIndex=1">首页</a>
                <c:if test="${pageBean.pageNo>1 }">
                    <a href="${pageContext.request.contextPath}/bac/appinfo/list?pageIndex=${pageBean.pageNo-1}">上一页</a>
                </c:if>
                <c:if test="${pageBean.pageNo<pageBean.totalPageCount}">
                    <a href="${pageContext.request.contextPath}/bac/appinfo/list?pageIndex=${pageBean.pageNo+1 }">下一页</a>
                </c:if>
                <a href="${pageContext.request.contextPath}/bac/appinfo/list?pageIndex=${pageBean.totalPageCount}">末页</a>
            </div>
        </div>
